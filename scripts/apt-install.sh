...
sudo aptitude install audacity build-essential git-core gpw inkscape signing-party subversion 
...
sudo aptitude install python2.6 python-beautifulsoup python-crypto python-feedparser python-matplotlib python-networkx python-markdown python-pygraphviz python-rsvg python-sqlalchemy python-yaml 
